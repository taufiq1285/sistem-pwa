/**
 * Routes Configuration - FIXED VERSION
 * Define all route paths for the application
 * 
 * UPDATED: Removed MATA_KULIAH (not needed for praktikum system)
 */
...
export const ROUTES = {
  ...
  DOSEN: {
    ...
    // âŒ REMOVED: MATA_KULIAH (not needed)
    // âŒ REMOVED: KELAS (not needed)
    JADWAL: '/dosen/jadwal',
    KUIS: {
      LIST: '/dosen/kuis',
