...
export default function LaporanPage() {
  ...
  const renderLoadingState = (label: string) => (
    <div className="space-y-4">
      <div className="h-4 w-48 skeleton-shimmer rounded-xs" />
        ...
        >
            ...
            <div className="space-y-4">
              <div className="space-y-1">
                ...
                <p className="report-print-subtitle max-w-3xl text-sm text-slate-600">
                  Rekap resmi kegiatan laboratorium untuk kebutuhan dokumentasi,
                  evaluasi operasional, dan pertanggungjawaban kegiatan.
                </p>
              </div>
          ...
          >
            <div className="report-print-section-header border-b border-slate-300 pb-2">
              ...
              <p className="text-sm text-slate-600">
                Snapshot kondisi inventaris untuk menilai ketersediaan alat dan
                kebutuhan tindak lanjut stok.
              </p>
            </div>
            <div className="report-print-metrics report-print-tight grid grid-cols-1 gap-2">
      ...
      <div className="print:hidden">
            ...
            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-[1fr_1fr_auto_auto]">
              ...
              <div className="flex items-end">
                <Button
                  ...
                  variant="outline"
                  disabled={loadingAny && !period.startDate && !period.endDate}
                >
                  Reset Periode
                </Button>
              </div>
        ...
        >
                ...
                <div className="grid gap-4 lg:grid-cols-3">
                  ...
                  >
                    ...
                    <CardContent className="space-y-3">
                      ...
                      <div className="text-xs text-muted-foreground">
                        Gunakan tab `Peminjaman` untuk melihat rekap detail dan
                        ekspor CSV.
                      </div>
                    </CardContent>
                  </GlassCard>
                  ...
                  >
                    ...
                    <CardContent className="space-y-3">
                      ...
                      <div className="text-xs text-muted-foreground">
                        Gunakan tab `Laboratorium` untuk melihat rekap utilisasi
                        dan ekspor CSV.
                      </div>
                    </CardContent>
                  </GlassCard>
          ...
          <TabsContent value="equipment" className="space-y-6">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-xl font-semibold mb-4">Rekap Inventaris</h2>
                <p className="text-sm text-muted-foreground mb-4">
                  Ringkasan kondisi stok dan kategori inventaris untuk rekap dan
                  ekspor.
                </p>
              </div>
              <Button
