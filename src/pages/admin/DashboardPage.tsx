    ...
    return (
      <div className="flex h-full items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-blue-950 dark:to-indigo-900">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg font-medium text-foreground">Memuat Dashboard Admin</p>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
        <Card className="group hover:shadow-lg transition-shadow duration-200 border-0 shadow-sm">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-semibold text-slate-700 dark:text-slate-300">Total Users</CardTitle>
        ...
        <Card className="group hover:shadow-lg transition-shadow duration-200 border-0 shadow-sm">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-semibold text-slate-700 dark:text-slate-300">Mahasiswa</CardTitle>
          ...
          <CardContent>
            <div className="text-3xl font-bold text-slate-900 dark:text-white">{stats.totalMahasiswa}</div>
            <p className="text-xs text-slate-600 dark:text-slate-400">
              {Math.round((stats.totalMahasiswa / stats.totalUsers) * 100)}% dari total users
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="group hover:shadow-lg transition-shadow duration-200 border-0 shadow-sm">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-semibold text-slate-700 dark:text-slate-300">Dosen</CardTitle>
          ...
          <CardContent>
            <div className="text-3xl font-bold text-slate-900 dark:text-white">{stats.totalDosen}</div>
            <p className="text-xs text-slate-600 dark:text-slate-400">
              {Math.round((stats.totalDosen / stats.totalUsers) * 100)}% dari total users
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="group hover:shadow-lg transition-shadow duration-200 border-0 shadow-sm">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-semibold text-slate-700 dark:text-slate-300">Laboratorium</CardTitle>
          ...
          <CardContent>
            <div className="text-3xl font-bold text-slate-900 dark:text-white">{stats.totalLaboratorium}</div>
            <p className="text-xs text-slate-600 dark:text-slate-400">Lab tersedia</p>
          </CardContent>
        </Card>

        <Card className="group hover:shadow-lg transition-shadow duration-200 border-0 shadow-sm">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-semibold text-slate-700 dark:text-slate-300">Peralatan</CardTitle>
          ...
          <CardContent>
            <div className="text-3xl font-bold text-slate-900 dark:text-white">{stats.totalPeralatan}</div>
            <p className="text-xs text-slate-600 dark:text-slate-400">Total peralatan</p>
          </CardContent>
        </Card>
        ...
        <Card className="group hover:shadow-lg transition-shadow duration-200 border-0 shadow-sm bg-gradient-to-br from-rose-50 to-pink-50 dark:from-rose-950/20 dark:to-pink-950/20 border-rose-200 dark:border-rose-800">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-semibold text-rose-700 dark:text-rose-300">Menunggu Persetujuan</CardTitle>
          ...
          <CardContent>
            <div className="text-3xl font-bold text-rose-600 dark:text-rose-300">{stats.pendingApprovals}</div>
            <p className="text-xs text-rose-600 dark:text-rose-400">Perlu persetujuan admin</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card className="border-0 shadow-sm bg-white dark:bg-slate-800">
        <CardHeader className="pb-4">
          <div className="flex items-center space-x-2">
            ...
            <div>
              <CardTitle className="text-lg font-semibold text-slate-900 dark:text-white">Aksi Cepat</CardTitle>
            ...
            >
              <div className="flex items-center space-x-3 w-full">
                ...
                <div className="text-left">
                  ...
                  <div className="text-xs text-slate-500 dark:text-slate-400">User baru</div>
                </div>
              </div>
            </Button>
            ...
            >
              <div className="flex items-center space-x-3 w-full">
                ...
                <div className="text-left">
                  ...
                  <div className="text-xs text-slate-500 dark:text-slate-400">Info sistem</div>
                </div>
              </div>
            </Button>
            ...
            >
              <div className="flex items-center space-x-3 w-full">
                ...
                <div className="text-left">
                  ...
                  <div className="text-xs text-slate-500 dark:text-slate-400">Kelola lab</div>
                </div>
              </div>
            </Button>
            ...
            >
              <div className="flex items-center space-x-3 w-full">
                ...
                <div className="text-left">
                  ...
                  <div className="text-xs text-slate-500 dark:text-slate-400">Inventaris</div>
                </div>
              </div>
            </Button>
            ...
            >
              <div className="flex items-center space-x-3 w-full">
                ...
                <div className="text-left">
                  ...
                  <div className="text-xs text-slate-500 dark:text-slate-400">Statistik</div>
                </div>
              </div>
            </Button>
            ...
            >
              <div className="flex items-center space-x-3 w-full">
                ...
                <div className="text-left">
                  ...
                  <div className="text-xs text-slate-500 dark:text-slate-400">Hak akses</div>
                </div>
              </div>
            </Button>
          </div>
          ...
          <CardHeader className="pb-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <CardTitle className="text-lg font-semibold text-slate-900 dark:text-white">Pertumbuhan Pengguna</CardTitle>
                  <CardDescription className="text-slate-600 dark:text-slate-400">
              ...
              <div className="flex items-center space-x-2 text-sm text-green-600 dark:text-green-400">
                ...
                <span>+{userGrowth.length > 0 ? userGrowth[userGrowth.length - 1].users : 0} bulan ini</span>
              </div>
            </div>
          </CardHeader>
          <CardContent>
        ...
        <Card className="col-span-full lg:col-span-3 border-0 shadow-sm bg-white dark:bg-slate-800">
          <CardHeader className="pb-4">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <CardTitle className="text-lg font-semibold text-slate-900 dark:text-white">Distribusi Pengguna</CardTitle>
                <CardDescription className="text-slate-600 dark:text-slate-400">
        ...
        <Card className="col-span-full border-0 shadow-sm bg-white dark:bg-slate-800">
          <CardHeader className="pb-4">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <CardTitle className="text-lg font-semibold text-slate-900 dark:text-white">Penggunaan Laboratorium</CardTitle>
                <CardDescription className="text-slate-600 dark:text-slate-400">
          ...
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={labUsage} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                <CartesianGrid strokeDasharray="3 3" stroke="#e2e8f0" className="opacity-50" />
                <XAxis
                  dataKey="lab"
                  tick={{ fill: '#64748b', fontSize: 12 }}
          ...
          <CardHeader className="pb-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <CardTitle className="text-lg font-semibold text-slate-900 dark:text-white">Pengguna Baru</CardTitle>
                  <CardDescription className="text-slate-600 dark:text-slate-400">
          ...
          <CardHeader className="pb-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <CardTitle className="text-lg font-semibold text-slate-900 dark:text-white">Pengumuman Terbaru</CardTitle>
                  <CardDescription className="text-slate-600 dark:text-slate-400">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm font-medium text-slate-900 dark:text-white">Status Sistem: Online</span>
              </div>
