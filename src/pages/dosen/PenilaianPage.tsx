...
export default function DosenPenilaianPage() {
  ...
  const loadKelas = async (forceRefresh = false) => {
    try {
      ...
      logger.debug("[Penilaian] Kelas loaded:", filteredKelas.length);
    } catch (error) {
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50/70 p-3 shadow-sm">
                  ...
                  {!selectedMataKuliah && (
                    <div className="mt-2 flex items-center gap-2 rounded-xl border border-border/70 bg-white/80 px-3 py-1.5 text-xs font-semibold text-muted-foreground">
                      ...
                      <span>
                        Pilih mata kuliah agar nilai masuk ke konteks yang benar
                      </span>
                    </div>
                  )}
                </div>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="max-w-3xl text-sm font-semibold text-muted-foreground">
                          Mahasiswa yang sama dapat memiliki nilai berbeda untuk
                          mata kuliah berbeda. Data di halaman ini hanya untuk
                          kombinasi mata kuliah dan kelas yang sedang aktif.
                        </p>
                      </div>
                    </div>
                    <Button
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <CardTitle className="text-xl">
                      ...
                      {currentMataKuliahInfo?.nama_mk || "Mata Kuliah"} / Kelas{" "}
                      {currentNamaKelas || "-"}
                    </CardTitle>
            ...
            <Alert className="border-warning/40 bg-warning/5">
              ...
              <AlertDescription className="flex items-center justify-between">
                <span className="text-warning">
                  <strong>Perhatian!</strong> Ada {editedGrades.size} perubahan
                  yang belum disimpan. Klik tombol{" "}
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                <div>
                  ...
                  <p className="mt-1 font-medium leading-relaxed">
                    Isi bobot komponen tersebut dengan <strong>0%</strong>, lalu
                    pindahkan bobotnya ke komponen lain sampai total tetap{" "}
                    <strong>100%</strong>.
                  </p>
                </div>
                <Button
