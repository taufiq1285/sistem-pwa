...
describe('Kehadiran API', () => {
  ...
  describe('getKehadiranByJadwal', () => {
    ...
    it('should order by mahasiswa NIM ascending', async () => {
      ...
      expect(orderMock).toHaveBeenCalledWith('mahasiswa(nim)', { ascending: true });
    });
  ...
  describe('getKehadiranByKelas', () => {
    ...
    it('should apply date range filters when provided', async () => {
      ...
      expect(gteMock).toHaveBeenCalledWith('jadwal.tanggal_praktikum', '2025-01-01');
      expect(lteMock).toHaveBeenCalledWith('jadwal.tanggal_praktikum', '2025-01-31');
    });
