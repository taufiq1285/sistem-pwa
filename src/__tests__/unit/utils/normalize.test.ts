...
describe("Data Normalization Utilities", () => {
  ...
  describe("normalizeEmail", () => {
    it("should convert to lowercase", () => {
      expect(normalizeEmail("SITI@MAHASISWA.AC.ID")).toBe(
        "siti@mahasiswa.ac.id",
      );
      expect(normalizeEmail("Siti@Mahasiswa.AC.ID")).toBe(
        "siti@mahasiswa.ac.id",
      );
  ...
  describe("normalizeKelasNama", () => {
    ...
    it("should handle hyphens", () => {
      ...
      expect(normalizeKelasNama("kelas a -praktikum")).toBe(
        "Kelas A -Praktikum",
      );
    });
  ...
  describe("normalizeProgramStudi", () => {
    it("should convert to title case", () => {
      ...
      expect(normalizeProgramStudi("teknik informatika")).toBe(
        "Teknik Informatika",
      );
    });
  ...
  describe("normalizeDosenNama", () => {
    ...
    it("should trim whitespace", () => {
      expect(normalizeDosenNama("  dr. budi santoso  ")).toBe(
        "Dr. Budi Santoso",
      );
    });
  ...
  describe("edge cases", () => {
    ...
    it("should handle very long inputs", () => {
      ...
      expect(result.split(" ").every((word: string) => word === "A")).toBe(
        true,
      );
    });
  });
