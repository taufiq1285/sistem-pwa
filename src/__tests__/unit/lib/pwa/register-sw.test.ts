...
describe("register-sw", () => {
  ...
  // ==========================================
  // SECTION 2: Update Flow - Registration
  // ==========================================

  describe("Update Flow - Registration", () => {
    it("should track installing worker on initial registration", async () => {
    ...
    it("should handle worker state transition to installed", async () => {
      ...
      expect(installingWorker.addEventListener).toHaveBeenCalled();
    });

    it("should handle worker state transition to activated", async () => {
      const installingWorker = {
        state: "installing",
        addEventListener: vi.fn((event, handler) => {
          if (event === "statechange") {
    ...
    it("should handle worker state transition to redundant", async () => {
      const installingWorker = {
        state: "installing",
        addEventListener: vi.fn((event, handler) => {
          if (event === "statechange") {
  ...
  // ==========================================
  // SECTION 3: Update Detection - updatefound
  // ==========================================
