...
vi.mock("../../../lib/supabase/client", () => {
  ...
  const mockSupabaseFrom = vi.fn().mockReturnValue(mockSupabaseStorage);
...
describe("Supabase Storage Service", () => {
  ...
  beforeEach(() => {
    ...
    // Get mocked instances and reset them
    mockSupabaseFrom = vi.mocked(supabase.storage.from);
    ...
    // Make sure from returns our mock storage
    mockSupabaseFrom.mockReturnValue(mockSupabaseStorage);
