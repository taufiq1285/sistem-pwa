...
import { getAnswerLabel, getCorrectAnswerLabel } from '@/lib/utils/quiz-scoring';
...
export function AnswerReview({
  ...
  const isManuallyGraded = needsManualGrading && jawaban?.poin_diperoleh !== null && jawaban?.poin_diperoleh !== undefined;
