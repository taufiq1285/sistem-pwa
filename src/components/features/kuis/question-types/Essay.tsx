...
import { getDefaultEssaySettings } from "./essay.utils";
...
const DEFAULT_SETTINGS = getDefaultEssaySettings();
...
export function Essay({
  ...
  characterLimit = DEFAULT_SETTINGS.characterLimit,
  rubric = "",
  onChange,
  disabled = false,
  showErrors = false,
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardContent className="pt-6 space-y-4">
          <div className="space-y-2">
            ...
            {rubric && (
              <div className="mt-2">
                <Badge variant="secondary">{rubric.length} karakter</Badge>
              </div>
            )}
          </div>
        </CardContent>
      ...
      <Alert>
        ...
        <AlertDescription>
          <strong>Catatan:</strong> Soal essay akan dinilai secara manual oleh
          dosen. Mahasiswa akan melihat skor setelah dosen memberikan penilaian.
        </AlertDescription>
      </Alert>
          ...
          <div className="space-y-2 text-sm text-muted-foreground">
            ...
            {characterLimit > 0 && (
              <div className="flex items-center justify-between">
                ...
                <span className="font-medium text-foreground">
                  {characterLimit.toLocaleString("id-ID")}
                </span>
              </div>
            )}
            <div className="flex items-center justify-between">
