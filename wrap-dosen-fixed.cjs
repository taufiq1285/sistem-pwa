...
// Step 1: Add middleware import (only if not present)
...
const functionsToWrap = [
  { name: 'createBorrowingRequest', permission: 'create:peminjaman' },
  { name: 'returnBorrowingRequest', permission: 'update:peminjaman' },
  { name: 'markBorrowingAsTaken', permission: 'update:peminjaman' },
];
