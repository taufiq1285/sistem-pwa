...
// Test UUIDs
const TEST_JADWAL_ID = "123e4567-e89b-12d3-a456-426614174000";
const TEST_KEHADIRAN_ID = "223e4567-e89b-12d3-a456-426614174001";
const TEST_MHS_ID = "323e4567-e89b-12d3-a456-426614174002";
const TEST_KELAS_ID = "423e4567-e89b-12d3-a456-426614174003";

describe("Kehadiran API", () => {
  const mockKehadiran: KehadiranWithMahasiswa = {
    id: TEST_KEHADIRAN_ID,
    jadwal_id: TEST_JADWAL_ID,
    mahasiswa_id: TEST_MHS_ID,
    status: "hadir",
  ...
  describe("getKehadiranByJadwal", () => {
    it("should fetch kehadiran by jadwal_id successfully", async () => {
      ...
      const result = await getKehadiranByJadwal(TEST_JADWAL_ID);
    ...
    it("should order by mahasiswa NIM ascending", async () => {
      ...
      await getKehadiranByJadwal(TEST_JADWAL_ID);
    ...
    it("should handle errors gracefully", async () => {
      ...
      await expect(getKehadiranByJadwal(TEST_JADWAL_ID)).rejects.toThrow();
    });
  ...
  describe("getKehadiranByKelas", () => {
    it("should fetch kehadiran by kelas_id successfully", async () => {
      ...
      const result = await getKehadiranByKelas(TEST_KELAS_ID);
    ...
    it("should apply date range filters when provided", async () => {
      ...
      await getKehadiranByKelas(TEST_KELAS_ID, "2025-01-01", "2025-01-31");
    ...
    it("should handle errors gracefully", async () => {
      ...
      await expect(getKehadiranByKelas(TEST_KELAS_ID)).rejects.toThrow();
    });
  });
  ...
  describe("getKehadiranStats", () => {
    it("should calculate stats correctly with all statuses", async () => {
      ...
      const result = await getKehadiranStats(TEST_MHS_ID, TEST_KELAS_ID);
    ...
    it("should handle errors gracefully", async () => {
      ...
      await expect(getKehadiranStats(TEST_MHS_ID, TEST_KELAS_ID)).rejects.toThrow();
    });
  ...
  describe("calculateNilaiKehadiran", () => {
    it("should calculate nilai with hadir only (100)", async () => {
      ...
      const nilai = await calculateNilaiKehadiran(TEST_MHS_ID, TEST_KELAS_ID);
  ...
  describe("getMahasiswaKehadiran", () => {
    it("should fetch mahasiswa kehadiran records successfully", async () => {
      ...
      const result = await getMahasiswaKehadiran(TEST_MHS_ID);
    ...
    it("should limit results to 100", async () => {
      ...
      await getMahasiswaKehadiran(TEST_MHS_ID);
    ...
    it("should handle errors gracefully", async () => {
      ...
      await expect(getMahasiswaKehadiran(TEST_MHS_ID)).rejects.toThrow();
    });
