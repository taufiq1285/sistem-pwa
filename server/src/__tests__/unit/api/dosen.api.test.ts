...
// Test UUIDs
const TEST_DOSEN_ID = "123e4567-e89b-12d3-a456-426614174000";
const TEST_KELAS_ID = "223e4567-e89b-12d3-a456-426614174001";
const TEST_MK_ID = "323e4567-e89b-12d3-a456-426614174002";
const TEST_MHS_ID = "423e4567-e89b-12d3-a456-426614174003";
const TEST_USER_ID = "523e4567-e89b-12d3-a456-426614174004";
const TEST_KUIS_ID = "623e4567-e89b-12d3-a456-426614174005";
  ...
  describe("getDosenStats", () => {
    it("should return stats for authenticated dosen", async () => {
      ...
      kelasDataBuilder._setResolveValue({
        data: [{ id: TEST_KELAS_ID }, { id: "kelas-2" }],
        error: null,
      });
      ...
      kuisDataBuilder._setResolveValue({
        data: [{ id: TEST_KUIS_ID }, { id: "kuis-2" }],
        error: null,
      });
...
describe("Dosen API - Kelas Management", () => {
  beforeEach(() => {
    vi.clearAllMocks();
    localStorageMock.clear();
    localStorageMock.setItem("cached_dosen_id", TEST_DOSEN_ID);
  });
  ...
  describe("getMyMataKuliah", () => {
    it("should return mata kuliah with aggregated stats", async () => {
      ...
      kelasBuilder._setResolveValue({
        data: [
          {
            id: TEST_KELAS_ID,
            mata_kuliah: { ...mockMataKuliah, id: TEST_MK_ID },
          },
          {
            id: "kelas-2",
            mata_kuliah: { ...mockMataKuliah, id: TEST_MK_ID }, // Same MK
          },
        ],
        error: null,
      });
    ...
    it("should apply limit when provided", async () => {
      ...
      kelasBuilder._setResolveValue({
        data: [
          { id: TEST_KELAS_ID, mata_kuliah: { ...mockMataKuliah, id: TEST_MK_ID } },
          {
            id: "kelas-2",
            mata_kuliah: {
              ...mockMataKuliah,
...
describe("Dosen API - Student Management", () => {
  ...
  describe("getKelasStudents", () => {
    it("should return students for a kelas", async () => {
      ...
      const result = await getKelasStudents(TEST_KELAS_ID);
