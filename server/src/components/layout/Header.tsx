...
export function Header({
  ...
  return (
    ...
    >
      <div className="flex h-16 items-center justify-between px-3 md:px-5 lg:px-6">
        ...
        <div className="flex min-w-0 items-center gap-2 md:gap-3">
          ...
          {/* Page title placeholder to preserve visual rhythm */}
          <div className="hidden md:block">
            <h1 className="text-sm font-semibold tracking-tight text-foreground/80 lg:text-base">
              Sistem Praktikum
            </h1>
          </div>
        </div>
