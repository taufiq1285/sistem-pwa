...
export function QuizTimer({
  ...
  const isWarning =
    minutes < WARNING_THRESHOLD_MINUTES &&
    minutes >= CRITICAL_THRESHOLD_MINUTES;
    ...
    <div className="space-y-4">
      ...
      <div
        className={cn(
          ...
          isCritical &&
            "border-red-300 bg-red-50 dark:border-red-800 dark:bg-red-950 animate-pulse",
          isWarning &&
            !isCritical &&
            "border-yellow-300 bg-yellow-50 dark:border-yellow-800 dark:bg-yellow-950",
          !isWarning &&
      ...
      >
        ...
        <div
          className={cn("text-5xl font-mono font-bold mb-4", getColorClass())}
        >
          {formatTime(timeRemaining)}
        </div>
      ...
      {isCritical && (
        <Alert variant="destructive">
          ...
          <AlertDescription>
            <strong>Waktu hampir habis!</strong> Kuis akan otomatis tersubmit
            dalam {minutes} menit {seconds} detik.
          </AlertDescription>
        </Alert>
      )}
      ...
      {isWarning && !isCritical && (
        <Alert className="border-yellow-300 bg-yellow-50 text-yellow-900 dark:border-yellow-800 dark:bg-yellow-950 dark:text-yellow-100">
          <AlertTriangle className="h-4 w-4" />
          <AlertDescription>
            Perhatian! Waktu tinggal {minutes} menit. Segera selesaikan jawaban
            Anda.
          </AlertDescription>
        </Alert>
      )}
